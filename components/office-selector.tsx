...
export function OfficeSelector({ value, onChange }: OfficeSelectorProps) {
  ...
  return (
    <button
      ...
      className="inline-flex h-8 sm:h-9 items-center rounded-full border border-slate-300 bg-slate-100/80 px-1 text-xs font-medium text-slate-600 transition hover:bg-slate-200/80 dark:border-white/18 dark:bg-white/[0.06] dark:text-slate-200 dark:hover:bg-white/[0.12]"
      title="切换办公地"
      aria-label="切换办公地"
    >
