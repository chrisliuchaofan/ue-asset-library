                    ...
                    {(showAll ? allTemplates : results).map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className="w-full text-left bg-card border border-border rounded-lg p-3 hover:bg-white/[0.03] transition-all space-y-2 focus-visible:outline-2 focus-visible:outline-primary"
                            >
                                <div className="flex items-center justify-between">
